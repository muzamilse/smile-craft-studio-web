        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-800">Dr Mourad Gamani</h3>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li><Link to="/about" className="hover:text-blue-600 transition-colors">About Dr. Gamani</Link></li>
