        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-12 py-16 sm:py-24 lg:py-40">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-24 items-center max-w-8xl mx-auto">
            ...
            <div className="relative lg:pl-8 xl:pl-16">
              ...
              <div className="absolute bottom-2 right-2 sm:bottom-4 sm:right-4 lg:bottom-6 lg:right-6 bg-gradient-to-br from-slate-950/98 via-gray-950/98 to-black/98 backdrop-blur-3xl rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-[0_15px_30px_rgba(0,0,0,0.8)] border border-yellow-500/40 luxury-glow p-2 sm:p-3 lg:p-4 w-[140px] sm:w-[160px] lg:w-[180px] z-20">
